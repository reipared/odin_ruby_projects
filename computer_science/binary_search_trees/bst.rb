...
class Tree
  ...
  # in their perspective depth-first order
  ...
  # hegiht: number of edges from a node to the lowest lead in its subtree
  ...
  # accepts a node and return its depth. Returns -1 if node doesn't exist
